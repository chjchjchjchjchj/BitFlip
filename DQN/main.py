import sys
sys.path.append("/root/autodl-tmp/ling/")
import gym
import torch
...
def main(args):
    ...
    agent = DQN(state_dim=state_dim, hidden_dim=hidden_dim, action_dim=action_dim, learning_rate=lr, gamma=gamma, epsilon=epsilon, target_update=target_update, device=device, length=length, policy_type="vanila", checkpoint_dir=checkpoint_dir)
