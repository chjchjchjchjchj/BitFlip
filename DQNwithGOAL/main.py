...
def main(args):
    ...
    log_dir = f"/root/BitFlip/dqn_g_length/bits={args.length},model={model_name},reward={(reward_success,reward_fail)},reward_type={reward_type},init_e={args.epsilon},target_update={args.target_update}"
    writer = SummaryWriter(log_dir=log_dir, comment=f"bits={args.length},model={model_name},reward={(reward_success,reward_fail)},init_e={args.epsilon},reward_type={reward_type}")
